...
def process_alpaca(dp):
    return (dp['instruction'], dp['input']), dp["output"]

def process_probes(dp):
    return dp['instruction'], dp["answer"]

def process_repeat(dp):
    return dp['instruction'], dp["repeat"]