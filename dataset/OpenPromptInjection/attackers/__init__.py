...
from .AdaptiveAttacker import AdaptiveAttacker
...
def create_attacker(attack_strategy, task):
    ...
    if attack_strategy == 'naive':
        ...
        return AdaptiveAttacker(attack_strategy, task)
    
    err_msg = f"{attack_strategy} is not a valid attack strategy."
    err_msg = f"{err_msg}\nValid attack strategy is one of ['naive', 'escape', 'ignore', 'fake_comp', 'combine', 'adaptive']"
